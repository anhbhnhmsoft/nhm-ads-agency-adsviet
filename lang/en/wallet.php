...
return [
    ...
    'telegram' => [
        ...
        'spending_fee_group_alert' => "💳 <b>POSTPAY SPENDING FEE CHARGED SUCCESSFULLY</b>\n<b>Customer:</b> :name\n<b>Package:</b> :package\n<b>Spend Amount:</b> :spend_amount USD\n<b>Fee Charged:</b> :fee_amount USDT\n<b>Tx Code:</b> :transaction_code\n<b>Time:</b> :time",
        'postpay_insufficient_group_alert' => "⚠️ <b>CAMPAIGNS PAUSED (INSUFFICIENT WALLET BALANCE)</b> ⚠️\n<b>Customer:</b> :name\n<b>Order:</b> :order_code\n<b>Package:</b> :package (:platform)\n<b>Wallet Balance:</b> :balance USDT\n<b>Minimum Required:</b> :min_wallet USDT\n<b>Fee Due:</b> :charge_amount USDT (Spend: :unbilled_spend USD)\n<b>Status:</b> :status_detail\n<b>Time:</b> :time",
        'postpay_insufficient_group_alert_failed' => "🚨 <b>EMERGENCY ALERT: CAMPAIGNS PAUSE FAILED</b> 🚨\n<b>Customer:</b> :name\n<b>Order:</b> :order_code\n<b>Package:</b> :package (:platform)\n<b>Wallet Balance:</b> :balance USDT\n<b>Fee Due:</b> :charge_amount USDT (Spend: :unbilled_spend USD)\n<b>Pause Result:</b> ❌ Failed :failed/:total campaigns (Success :success)\n<b>Error Reason:</b> :error_reason\n👉 <b>ACTION REQUIRED:</b> Admin/Staff must manually pause campaigns in Ads Manager IMMEDIATELY to prevent unwanted spend!\n<b>Time:</b> :time",
        'pause_all_success_detail' => "All campaigns (:success/:total) have been paused successfully due to insufficient wallet balance.",
        'pause_no_campaigns_detail' => "No active campaigns to pause.",
