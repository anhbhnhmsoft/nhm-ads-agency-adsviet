...
return [
    ...
    'telegram' => [
        ...
        'spending_fee_group_alert' => "💳 <b>THU PHÍ SPENDING TRẢ SAU THÀNH CÔNG</b>\n<b>Khách hàng:</b> :name\n<b>Gói:</b> :package\n<b>Chi tiêu:</b> :spend_amount USD\n<b>Phí đã thu:</b> :fee_amount USDT\n<b>Mã GD:</b> :transaction_code\n<b>Thời gian:</b> :time",
        'postpay_insufficient_group_alert' => "⚠️ <b>TẠM DỪNG CHIẾN DỊCH (SỐ DƯ VÍ KHÔNG ĐỦ)</b> ⚠️\n<b>Khách hàng:</b> :name\n<b>Mã đơn:</b> :order_code\n<b>Gói:</b> :package (:platform)\n<b>Số dư ví:</b> :balance USDT\n<b>Mức duy trì tối thiểu:</b> :min_wallet USDT\n<b>Phí cần thu:</b> :charge_amount USDT (Chi tiêu: :unbilled_spend USD)\n<b>Trạng thái:</b> :status_detail\n<b>Thời gian:</b> :time",
        'postpay_insufficient_group_alert_failed' => "🚨 <b>CẢNH BÁO KHẨN: TẠM DỪNG CAMPAIGN THẤT BẠI</b> 🚨\n<b>Khách hàng:</b> :name\n<b>Mã đơn:</b> :order_code\n<b>Gói:</b> :package (:platform)\n<b>Số dư ví:</b> :balance USDT\n<b>Phí cần thu:</b> :charge_amount USDT (Chi tiêu: :unbilled_spend USD)\n<b>Kết quả Pause:</b> ❌ Thất bại :failed/:total campaign (Thành công :success)\n<b>Lý do lỗi:</b> :error_reason\n👉 <b>YÊU CẦU:</b> Admin/Kỹ thuật vui lòng vào Ads Manager TẮT THỦ CÔNG NGAY LẬP TỨC để tránh phát sinh chi phí!\n<b>Thời gian:</b> :time",
        'pause_all_success_detail' => "Đã tạm dừng thành công toàn bộ :success/:total campaign do số dư ví không đủ điều kiện.",
        'pause_no_campaigns_detail' => "Không có campaign nào đang chạy cần tạm dừng.",
