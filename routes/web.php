...
Route::middleware([
    ...
    Route::prefix('transactions')->group(function () {
        ...
        Route::get('/export', [WalletTransactionController::class, 'export'])->name('transactions_export');
    ...
    Route::prefix('/service-management')->group(function () {
        ...
        Route::get('/export', [ServiceManagementController::class, 'export'])->name('service_management_export');
    ...
    Route::prefix('/business-managers')->group(function () {
        ...
        Route::get('/list', [BusinessManagerController::class, 'getBmListJson'])->name('business_managers_list_json');
