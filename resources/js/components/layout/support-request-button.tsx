...
export function SupportRequestButton() {
    ...
    const handleSubmitSupportRequest = (e: React.FormEvent) => {
        ...
        const subjectMap: Record<typeof supportType, string> = {
            account_close: t(
                'service_management.support_request_type_account_close',
            ),
            account_appeal: t(
                'service_management.support_request_type_account_appeal',
            ),
            transfer_budget: t(
                'service_management.support_request_type_transfer_budget',
            ),
            share_bm: t('service_management.support_request_type_share_bm'),
            wallet_withdraw_app: t(
                'service_management.support_request_type_wallet_withdraw_app',
            ),
        };

        const subject =
            subjectMap[supportType] ||
            ...
            >
                <DialogContent className="bg-white">
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            {t(
                                'service_management.support_request_description',
                            )}
                        </DialogDescription>
                    </DialogHeader>
                    <form
                    ...
                    >
                        <div className="space-y-2">
                            <Label htmlFor="global-support-type">
                                {t(
                                    'service_management.support_request_type_label',
                                )}
                            </Label>
                            <UiSelect
                                value={supportType}
                            ...
                            >
                                ...
                                <UiSelectContent>
                                    ...
                                    <UiSelectItem value="share_bm">
                                        {t(
                                            'service_management.support_request_type_share_bm',
                                        )}
                                    </UiSelectItem>
                            ...
                            <div className="space-y-3">
                                <div className="space-y-2">
                                    <Label htmlFor="withdraw-amount">
                                        {t(
                                            'service_management.support_request_withdraw_amount_label',
                                        )}
                                    </Label>
                                    <Input
                                        id="withdraw-amount"
                                ...
                                <div className="space-y-2">
                                    <Label htmlFor="withdraw-type">
                                        {t(
                                            'service_management.support_request_withdraw_type_label',
                                        )}
                                    </Label>
                                    <UiSelect
                                        value={withdrawType}
                                ...
                                <div className="space-y-2">
                                    <Label htmlFor="withdraw-wallet-password">
                                        {t(
                                            'service_management.support_request_wallet_password_label',
                                        )}
                                    </Label>
                                    <Input
                        ...
                        <div className="space-y-2">
                            <Label htmlFor="global-support-note">
                                {t(
                                    'service_management.support_request_note_label',
                                )}
                            </Label>
                            <Textarea
                        ...
                        <DialogFooter>
                            ...
                            >
                                {supportForm.processing
                                    ? t('common.sending')
                                    : t(
                                          'service_management.support_request_submit',
                                      )}
                            </Button>
                        </DialogFooter>
                    </form>
