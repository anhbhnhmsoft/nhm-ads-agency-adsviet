...
const WalletActionsTabs = ({
    ...
    return (
        <Card>
            <CardHeader>
                <CardTitle>{t('wallet.actions')}</CardTitle>
            </CardHeader>
            <CardContent>
                        ...
                        <form onSubmit={handleTopUp} className="space-y-4">
                            <div className="space-y-2">
                                ...
                                <select
                                    ...
                                    required
                                >
                                    <option value="" disabled>{t('wallet.select_network_placeholder')}</option>
                                    {networks.map((n) => (
                                ...
                                {networks.length === 0 && (
                                    <div className="text-sm text-muted-foreground">
                                        {t('wallet.network_not_configured')}
                                    </div>
                                )}
                            </div>
                            <div className="space-y-2">
                        ...
                        <form onSubmit={handleChangePassword} className="space-y-4">
                            {walletHasPassword && (
                                <div className="space-y-2">
                                    ...
                                    <Input
                                        ...
                                        required
                                        placeholder={t('wallet.enter_current_password')}
                                    />
                            ...
                            <div className="space-y-2">
                                ...
                                <Input
                                    ...
                                    placeholder={t('wallet.enter_new_password')}
                                    required
                                    minLength={6}
                                />
                            ...
                            <div className="space-y-2">
                                ...
                                <Input
                                    ...
                                    placeholder={t('wallet.enter_confirm_password')}
                                    required
                                    minLength={6}
                                />
