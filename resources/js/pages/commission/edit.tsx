...
type Props = {
    commission: EmployeeCommissionItem;
    packages: ServicePackage[];
};

const Edit = ({ commission, packages }: Props) => {
    const { t } = useTranslation();
    const { form, submit } = useFormUpdateCommission({
        service_package_id: commission.service_package_id,
    ...
    return (
        <AppLayout>
            <div className="space-y-6">
                ...
                <form onSubmit={submit(commission.id)} className="space-y-6">
