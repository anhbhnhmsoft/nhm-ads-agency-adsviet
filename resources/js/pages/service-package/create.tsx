...
const Create = ({
    ...
    const parseMonthlyRangeToMinMax = (
        ...
        // dạng "10000-50000" hoặc "10000 – 50000"
    ...
    return (
        <form className="space-y-4" onSubmit={submit}>
            <h1 className="text-xl font-semibold">
                {t('service_packages.title_create')}
            </h1>
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <Input
                        ...
                        step={'any'}
                        onChange={(e) => {
                            setData('top_up_fee', e.target.value);
                        }}
                        required
                    />
                    {errors.top_up_fee && (
                ...
                {data.refund_open_fee && (
                    <div className="flex flex-col gap-2">
                        ...
                        <Input
                            value={data.min_spend_for_refund}
...
Create.layout = (page: ReactNode) => (
    <AppLayout
        breadcrumbs={[
            ...
            {
                title: 'menu.service_packages_create',
            },
        ]}
        children={page}
    />
