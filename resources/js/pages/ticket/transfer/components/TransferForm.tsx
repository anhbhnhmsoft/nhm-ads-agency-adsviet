                ...
                <Alert className="mb-4">
                    ...
                    <AlertDescription>
                        {t('ticket.transfer.warning', {
                            defaultValue:
                                'Các TKQC chuyển đi cần được tắt camp tối thiểu 5 tiếng',
                        })}
                    </AlertDescription>
                </Alert>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="space-y-2">
                        ...
                        >
                            ...
                            <SelectContent>
                                <SelectItem
                                    value={String(TRANSFER_PLATFORM_META)}
                                >
                                ...
                                <SelectItem
                                    value={String(TRANSFER_PLATFORM_GOOGLE)}
                                >
                    ...
                    <div className="space-y-2">
                        ...
                        <Textarea
                            ...
                            placeholder={t(
                                'ticket.transfer.notes_placeholder',
                    ...
                    <div className="flex justify-end">
                        <Button type="submit" disabled={form.processing}>
                            ...
                            {form.processing
                                ...
                                : t('ticket.transfer.send_request', {
