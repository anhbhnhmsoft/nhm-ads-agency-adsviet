            ...
            <CardContent>
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <PlatformAccountSelector
                        ...
                        accountLabel={t('ticket.share.select_account', {
                            defaultValue: 'Chọn tài khoản',
                        })}
                        accountPlaceholder={t(
                            'ticket.share.select_account_placeholder',
                            { defaultValue: 'Chọn tài khoản' },
                        )}
                    ...
                    <div className="space-y-2">
                        ...
                        <Input
                            ...
                            onChange={(e) =>
                                form.setData('bm_bc_mcc_id', e.target.value)
                            }
                            placeholder={t(
                                'ticket.share.bm_bc_mcc_id_placeholder',
                                { defaultValue: 'Nhập ID BM/MCC' },
                            )}
                            disabled={form.processing}
                        />
                        ...
                        <p className="text-sm text-muted-foreground">
                            {t('ticket.share.domain_note', {
                                defaultValue:
                                    'Các tài khoản share cùng một BM/BC/MCC phải cùng chung một domain',
                            })}
                        </p>
                    </div>
                    ...
                    <div className="space-y-2">
                        ...
                        <Textarea
                            ...
                            placeholder={t('ticket.share.notes_placeholder', {
