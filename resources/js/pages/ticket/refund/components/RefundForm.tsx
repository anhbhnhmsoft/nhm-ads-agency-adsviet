...
export const RefundForm = ({ accounts }: RefundFormProps) => {
    ...
    const handleAddAccount = () => {
        if (
            ...
            !selectedAccounts.includes(form.data.account_id)
        ) {
            ...
            <CardContent>
                <form onSubmit={handleSubmit} className="space-y-6">
                    <PlatformAccountSelector
                        ...
                        accountLabel={t('ticket.refund.select_account', {
                            defaultValue: 'Chọn tài khoản thanh lý',
                        })}
                        accountPlaceholder={t(
                            'ticket.refund.select_account_placeholder',
                    ...
                    {selectedAccounts.length > 0 && (
                        <div className="space-y-2">
                            <Label>
                                {t('ticket.refund.selected_accounts', {
                                    defaultValue: 'Tài khoản đã chọn',
                                })}
                            </Label>
                            <div className="space-y-2">
                    ...
                    <div className="space-y-2">
                        ...
                        <RadioGroup
                            ...
                            onValueChange={(value) =>
                                form.setData('liquidation_type', value)
                            }
                            disabled={form.processing}
                        >
                            <div className="flex items-center space-x-2">
                                <RadioGroupItem
                                    value={REFUND_TYPE_WITHDRAW_TO_WALLET}
                                    id="withdraw_to_wallet"
                                />
                                <Label
                                    htmlFor="withdraw_to_wallet"
                        ...
                        {form.data.liquidation_type ===
                            REFUND_TYPE_WITHDRAW_TO_WALLET && (
                            <div className="ml-6 space-y-1 text-sm text-muted-foreground">
                                <p>
                                    {t('ticket.refund.processing_time', {
                                        defaultValue:
                                            'Thời gian xử lý 3 ngày làm việc',
                                    })}
                                </p>
                                <p>
                                    {t('ticket.refund.amount_warning', {
                                        defaultValue:
                                            'Số tiền thực tế có thể lệch do hệ thống facebook cập nhật chậm',
                                    })}
                                </p>
                            </div>
                        )}
                    ...
                    <div className="space-y-2">
                        ...
                        <Textarea
                            ...
                            placeholder={t('ticket.refund.notes_placeholder', {
