...
export const useRefundColumns = () => {
    ...
    const columns: ColumnDef<Ticket>[] = useMemo(
        () => [
            ...
            {
                id: 'platform',
                header: t('ticket.refund.platform', {
            ...
            {
                id: 'accounts',
                header: t('ticket.refund.accounts', {
                ...
                cell: ({ row }) => {
                    ...
                    if (Array.isArray(accountIds) && accountIds.length > 0) {
                        return accountIds
                            .map((accountId: string, index: number) => {
            ...
            {
                id: 'liquidation_type',
                header: t('ticket.refund.liquidation_type', {
                ...
                cell: ({ row }) => {
                    ...
                    if (liquidationType === 'withdraw_to_wallet') {
                        return t('ticket.refund.withdraw_to_wallet', {
