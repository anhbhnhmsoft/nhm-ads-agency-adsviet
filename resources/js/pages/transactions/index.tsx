                        ...
                        <form onSubmit={handleFilter} className="space-y-4">
                            <div className="grid gap-4 md:grid-cols-3">
                                <div className="space-y-2">
                                    ...
                                    <select
                                        id="filter-type"
                                        className="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm text-foreground shadow-sm ring-offset-background transition-colors placeholder:text-muted-foreground focus-visible:ring-1 focus-visible:ring-ring focus-visible:outline-none"
                                    ...
                                    >
                                        ...
                                        <option value="2">
                                            {t(
                                                ...
                                                { defaultValue: 'Rút tiền' },
                                            )}
                                        </option>
                                        <option value="3">
                                            {t(
                                                'wallet.transaction_type.refund',
                                        ...
                                        <option value="5">
                                            {t(
                                                'wallet.transaction_type.cashback',
                                                { defaultValue: 'Cashback' },
                                            )}
                                        </option>
                                        <option value="6">
                                            {t(
                                                'wallet.transaction_type.service_purchase',
                                                { defaultValue: 'Mua dịch vụ' },
                                            )}
                                        </option>
                                        <option value="7">
                                            {t(
                                                'wallet.transaction_type.campaign_budget_update_google',
                                                {
                                                    defaultValue:
                                                        'Cập nhật ngân sách Google Ads',
                                                },
                                            )}
                                        </option>
                                        <option value="8">
                                            {t(
                                                'wallet.transaction_type.campaign_budget_update_meta',
                                                {
                                                    defaultValue:
                                                        'Cập nhật ngân sách Meta Ads',
                                                },
                                            )}
                                        </option>
                                        <option value="13">
                                            {t(
                                                'wallet.transaction_type.account_top_up_google',
                                                {
                                                    defaultValue:
                                                        'Nạp tiền tài khoản Google Ads',
                                                },
                                            )}
                                        </option>
                                        <option value="14">
                                            {t(
                                                'wallet.transaction_type.account_top_up_meta',
                                                {
                                                    defaultValue:
                                                        'Nạp tiền tài khoản Meta Ads',
                                                },
                                            )}
                                        </option>
                                    </select>
                                ...
                                <div className="space-y-2">
                                    ...
                                    >
                                        ...
                                        <option value="4">
                                            {t(
                                                'wallet.transaction_status.completed',
                                                { defaultValue: 'Hoàn thành' },
                                            )}
                                        </option>
                                        <option value="5">
                                            {t(
                                                'wallet.transaction_status.cancelled',
                                                { defaultValue: 'Đã hủy' },
                                            )}
                                        </option>
                                    </select>
            ...
            <Card>
                <CardHeader>
                    <CardTitle className="flex items-center gap-2">
                        ...
                        {t('transactions.list', {
                            defaultValue: 'Danh sách giao dịch',
                        })}
...
TransactionsIndex.layout = (page: ReactNode) => (
    <AppLayout
        breadcrumbs={[{ title: 'transactions.title' }]}
        children={page}
    />
);
