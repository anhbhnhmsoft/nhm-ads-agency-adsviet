...
export enum _ConfigName {
    ...
    DASHBOARD_GUIDE_CONTENT = 'DASHBOARD_GUIDE_CONTENT',
}
...
export const configNameLabel: Record<_ConfigName, string> = {
    ...
    [_ConfigName.COINREMITTER_TRC20_API_KEY]:
        'config.coinremitter_trc20_api_key',
    [_ConfigName.COINREMITTER_TRC20_PASSWORD]:
        'config.coinremitter_trc20_password',
    ...
    [_ConfigName.DASHBOARD_GUIDE_CONTENT]: 'config.dashboard_guide_content',
};
...
export const metaAdsAccountStatusLabel: Record<_MetaAdsAccountStatus, string> =
    {
        ...
        [_MetaAdsAccountStatus.PENDING_RISK_REVIEW]:
            'meta.account_status.pending_risk_review',
        [_MetaAdsAccountStatus.PENDING_SETTLEMENT]:
            'meta.account_status.pending_settlement',
        [_MetaAdsAccountStatus.IN_GRACE_PERIOD]:
            'meta.account_status.in_grace_period',
        [_MetaAdsAccountStatus.PENDING_CLOSURE]:
            'meta.account_status.pending_closure',
...
export const googleCustomerStatusLabel: Record<_GoogleCustomerStatus, string> =
    {
        [_GoogleCustomerStatus.UNSPECIFIED]:
            'google_ads.account_status.unknown',
        ...
        [_GoogleCustomerStatus.SUSPENDED]:
            'google_ads.account_status.suspended',
