...
class GoogleAdsSpendingExceededAlert extends Mailable implements ShouldQueue
{
    ...
    {
        return new Envelope(
            subject: __('mail.google_ads_spending_exceeded.subject'),
        );
    }
    ...
    {
        return new Content(
            markdown: 'mail.google-ads-spending-exceeded',
            with: [
