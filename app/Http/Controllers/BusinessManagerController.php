...
class BusinessManagerController extends Controller
{
    ...
    /**
     * API JSON lấy danh sách BM/MCC nhẹ cho dropdown
     * Query trực tiếp bảng MetaBusinessManager + GoogleMccManager
     */
    public function getBmListJson(Request $request): \Illuminate\Http\JsonResponse
    {
        $this->ensureInternalAccess();
